 ...
 * Main dashboard for contractors with sidebar navigation and projects management
 */
      ...
      <div className="flex">
        ...
        <main className="flex-1 min-h-screen ml-0 md:ml-64">
          <div className="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            ...
            {activeMenu === 'projects' && <ContractorProjectsPage />}

            {/* Work Log Page */}
            {activeMenu === 'work-log' && <WorkLogPage />}
          </div>
        </main>
      </div>
    </div>
